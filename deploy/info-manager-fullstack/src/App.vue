<template>
  ...
  <main class="app-container">
    ...
    <section id="image-container" class="card">
      <h2>對應圖片</h2>
      <div id="image-section" :class="{ 'has-image': form.image }" @click="form.image ? openImageModal(form.image) : triggerImageImport()">
  ...
  <div v-if="showImageModal" class="image-modal-overlay" @click.self="closeImageModal">
    <div class="image-modal-content">
      <img :src="modalImageSrc" alt="放大圖片" class="image-modal-img">
...
<style>
  ...
  * {
  ...
  #image-section.has-image {
      cursor: zoom-in; /* 圖片存在時，游標變為放大鏡 */
      border: none; /* 圖片存在時移除虛線邊框 */
  }
